...
public class HeaderManagerInterceptor implements HandlerInterceptor{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
		...
		if(user.getRolename()==null){
			...
			return false;
		}else if(!user.getRolename().equals("人事部长")){
			if(user.getRolename().equals("总经理")||user.getRolename().equals("管理员")){
				return true;
			}else{
				request.getRequestDispatcher("/jsp/backstage/fail.jsp").forward(request, response);
				return false;
